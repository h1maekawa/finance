...
<template>
  <header class="fixed top-0 inset-x-0 z-50 bg-background/60 backdrop-blur-2xl border-b border-outline-variant/10 px-6 py-4 flex justify-between items-center transition-all duration-500">
